...
export const effectiveValue = curry((feePerByte, coin) => clamp(0, Infinity, Math.ceil(coin.value - feePerByte * inputBytes(coin))));

export const bip69SortInputs = sort((inputA, inputB) => inputComparator(inputA.txHash, inputA.value, inputB.txHash, inputB.value));
